...
class NewPaymentReqV2(BaseModel):
    amount: float
...
class UpdatePaymentReqV2(BaseModel):
...
class UpdatePurchasePaymentReqV2(BaseModel):
    amount: float | None = None
    month: int | None = None
    year: int | None = None
    status: PaymentStatusEnum | None = None
...
class PaymentListParamV2(BaseModel):
    # Pagination params
...
class NewSubscriptionPaymentReqV2(BaseModel):
    amount: float
    month: int = Field(ge=1, le=12)
    year: int = Field(ge=2000)


class UpdateSubscriptionPaymentReqV2(BaseModel):
    amount: float | None = None
    status: PaymentStatusEnum | None = None

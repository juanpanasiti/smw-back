...
from app.schemas.expense_schemas_v1 import NewExpenseReqV1, UpdateExpenseReqV1, ExpenseResV1
...
from app.schemas.payment_schemas_v1 import PaymentReqV1
...
from app.schemas.expense_schemas_v1 import ExpenseListParamsV1

logger = logging.getLogger(__name__)


class ExpenseControllerV1():
    ...
    def get_all(self, user_id: int, params: ExpenseListParamsV1) -> List[ExpenseResV1]:
        try:
            response = []
    ...
    def get_by_id(self, expense_id: int) -> ExpenseResV1:
        return self.expense_service.get_by_id(expense_id)

    def update(self, expense_id: int, expense: UpdateExpenseReqV1) -> ExpenseResV1:
    ...
    def __create_new_purchase_installments(self, new_purchase: ExpenseResV1):
        if new_purchase.id:
    ...
    def __create_new_subscription_installments(self, new_subscription: ExpenseResV1):
        new_installment = PaymentReqV1(

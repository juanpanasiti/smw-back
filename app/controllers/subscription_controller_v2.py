...
from app.services import SubscriptionServiceV2
...
class SubscriptionControllerV2:
    ...
    def subscription_service(self):
        if self.__subscription_service is None:
            self.__subscription_service = SubscriptionServiceV2()
        return self.__subscription_service

    @handle_exceptions
    def create(self, token: DecodedJWT, subscription_id: int, payment: NewSubscriptionPaymentReqV2) -> PaymentResV2:
    ...
    @handle_exceptions
    def update(self, subscription_id: int, payment_id: int, payment: UpdateSubscriptionPaymentReqV2) -> PaymentResV2:

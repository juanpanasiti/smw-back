...
from app.services import ExpenseCategoryServiceV2, ExpenseServiceV2


class ExpenseCategoryControllerV2:
    def __init__(self):
    ...
    def expense_category_service(self):
        if self.__expense_category_service is None:
            self.__expense_category_service = ExpenseCategoryServiceV2()

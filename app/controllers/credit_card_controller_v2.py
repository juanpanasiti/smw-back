...
from app.services import CreditCardServiceV2
...
class CreditCardControllerV2():
    def __init__(self) -> None:
        self.__credit_card_service = None

    @property
    def credit_card_service(self) -> CreditCardServiceV2:
        if self.__credit_card_service is None:
            self.__credit_card_service = CreditCardServiceV2()

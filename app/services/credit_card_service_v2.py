...
from app.services.expense_service_v2 import ExpenseServiceV2


logger = logging.getLogger(__name__)


class CreditCardServiceV2():
    def __init__(self) -> None:
        self.__credit_card_repo: CreditCardRepository = None
        self.__expense_repo: ExpenseServiceV2 = None
    ...
    @property
    def expense_service(self) -> ExpenseServiceV2:
